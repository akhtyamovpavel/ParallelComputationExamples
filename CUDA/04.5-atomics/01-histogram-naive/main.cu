...
__global__ void histogram_naive(const int* data, int n, int* bins, int num_bins) {
...
int main() {
    ...
    histogram_naive<<<grid, block>>>(d_data, N, d_bins, NUM_BINS);
    ...
    std::cout << std::left << std::setw(24) << "histogram_naive"
